...
"""
Как удалять елементы с таблицы? это можно сделать с помощью запроса DELETE, 
синтаксис:DELETE FROM table_name WHERE situation
важно заметить что это удалит все елементы с этих столбцов, допустим я укажу в условии id = 1 и он удалит все данные связанные с первым айди"""
"""
